...
excelFiles.forEach(file => {
    ...
    const monthNum = fileNameMonthRaw.slice(-2); // Take last 2 digits if it's like 2601
...
console.log(`Converted ${allRecords.length} records to src/data/records.json with correct month ${allRecords[0].month}`);
